 ...
 */
  esp_err_t ml_config_httpd_register_routes(
    ml_config_ctx_t * ctx, struct microlink_s * ml, httpd_handle_t httpd, const char * prefix);
...
static inline ml_config_ctx_t * ml_config_httpd_init(void)
{
  return NULL;
}

static inline int ml_config_httpd_start(ml_config_ctx_t * ctx, void * ml)
{
  (void)ctx;
  (void)ml;
  return 0;
...
static inline void ml_config_httpd_stop(ml_config_ctx_t * ctx)
{
  (void)ctx;
}

static inline void ml_config_httpd_deinit(ml_config_ctx_t * ctx)
{
  (void)ctx;
}

static inline int ml_config_httpd_register_routes(ml_config_ctx_t * c, void * m, void * h, const char * p)
{
  (void)c;
  (void)m;
  (void)h;
...
static inline void ml_config_httpd_set_ml(ml_config_ctx_t * c, void * m)
{
  (void)c;
  (void)m;
}

static inline bool ml_config_httpd_is_started(const ml_config_ctx_t * c)
{
  (void)c;
  return false;
}

static inline void ml_config_httpd_set_auth(ml_config_ctx_t * c, bool (*f)(void *))
{
  (void)c;
  (void)f;
}

static inline bool ml_config_peer_is_allowed(const ml_config_ctx_t * ctx, uint32_t ip)
{
  (void)ctx;
  (void)ip;
  return true;
...
static inline bool ml_config_allowlist_active(const ml_config_ctx_t * ctx)
{
  (void)ctx;
  return false;
}
...
static inline bool ml_config_get_nvs_wifi(char * s, size_t sl, char * p, size_t pl)
{
  (void)s;
  (void)sl;
  (void)p;
...
static inline bool ml_config_get_wifi_list(ml_config_wifi_list_t * l)
{
  (void)l;
  return false;
}
...
static inline const char * ml_config_get_wifi_ssid(const ml_config_ctx_t * c)
{
  (void)c;
  return NULL;
}

static inline const char * ml_config_get_wifi_pass(const ml_config_ctx_t * c)
{
  (void)c;
  return NULL;
}

static inline const char * ml_config_get_auth_key(const ml_config_ctx_t * c)
{
  (void)c;
  return NULL;
}

static inline const char * ml_config_get_device_prefix(const ml_config_ctx_t * c)
{
  (void)c;
  return NULL;
}

static inline const char * ml_config_get_device_name_full(const ml_config_ctx_t * c)
{
  (void)c;
  return NULL;
}

static inline uint8_t ml_config_get_max_peers(const ml_config_ctx_t * c)
{
  (void)c;
  return 0;
}

static inline uint16_t ml_config_get_disco_heartbeat_ms(const ml_config_ctx_t * c)
{
  (void)c;
  return 0;
}

static inline uint32_t ml_config_get_priority_peer_ip(const ml_config_ctx_t * c)
{
  (void)c;
  return 0;
}

static inline const char * ml_config_get_ctrl_host(const ml_config_ctx_t * c)
{
  (void)c;
  return NULL;
}
