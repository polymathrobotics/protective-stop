...
class ConnectionStatus(BaseModel):
    ...
    def check_status_type(cls, value):
        assert isinstance(value, PStopRemoteStatusEnum), 'status must be of type PStopRemoteStatusEnum'
        return value
...
class PStopModel(BaseModel):
    ...
    def to_ros_message(self, uuid: str) -> ProtectiveStopDebugRemote:
        return ProtectiveStopDebugRemote(
            ...
            receive_timestamp=self.receive_timestamp.to_time_msg() if self.receive_timestamp else None,
        )
