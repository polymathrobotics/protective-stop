...
class BaseTestProtectiveStopNode(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.activate_client = self.node.create_client(ProtectiveStopSrv, '/protective_stop_node/activate')
        ...
        self.deactivate_client = self.node.create_client(ProtectiveStopSrv, '/protective_stop_node/deactivate')
