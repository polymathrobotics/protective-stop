...
remains `docs/safety/`.
**Branch:** `change-0002-modification-procedure-enforcement`
**Base:** `main`
**Depends on:** change-0001 (safety traceability linter). Piece 6 consumes
`tools/safety_lint`. Pieces 1–5 and 7 do not.
**Status:** implementation and label synchronization complete; PR verification pending
...
**Stacked development base:** change-0001 commit `326a6d0` while PR #119 remains
open; the change-0002 PR still targets `main` and depends on #119 landing first.
