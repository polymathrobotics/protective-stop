...
// 3-07-1: Shall transition to a stopped state if a bonded operator
//         sends a stop message
// Description: After a successful bonding, send STOP message.
...
void
main_req_3_07_test(void)
{
    UnitySetTestFile("req_3_07_test.c");

    RUN_TEST(req_3_07_test);
}
